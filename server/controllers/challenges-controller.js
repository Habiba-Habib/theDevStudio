...
// GET /challenges/  — challenges listing page
exports.getChallengesPage = async (req, res) => {
  try {
...
// GET /challenges/:id  — single challenge description
exports.getChallengeDescriptionPage = async (req, res) => {
  try {
